...
[shift]
s0_initiate_key = <Control><Super>s
...
s0_prev_all_key = <Shift><Control>Tab
...
[animation]
s0_open_effects = animation:Wave;animation:Wave;animation:Wave;
...
s0_close_effects = animation:Dream;animation:Dream;animation:Dream;
...
[core]
s0_active_plugins = core;composite;opengl;resize;grid;commands;regex;mousepoll;animation;vpswitch;move;copytex;wobbly;workarounds;place;shift;imgpng;compiztoolbox;cube;session;scale;rotate;expo;unitymtgrabhandles;ezoom;unityshell;showdesktop;
