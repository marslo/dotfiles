...
- **Use GitHub callouts** for emphasis / tips / references — not bold prose:
  ...
  Scope: callouts are for Markdown **documents/files** — do **not** use `> [!NOTE]` / `> [!TIP]` etc. in chat / assistant replies.
